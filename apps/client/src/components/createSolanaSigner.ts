...
export interface TransactionSigner {
  address: string;
  signTransactions: (transactions: any[]) => Promise<Array<{ [address: string]: Uint8Array }>>;
}
 ...
 */
function convertToVersionedTransaction(tx: any): VersionedTransaction {
...
function extractSignature(
  ...
  return { [walletAddress]: signedTx.signatures[signerIndex] };
}
